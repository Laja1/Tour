...
const CustomPrevArrow = ({ onClick }:any) => (
 <div className="absolute -translate-y-1/2 top-1/2 pr-20"> <div
    className="   transform  bg-gray-800 rounded-full p-2 cursor-pointer z-10"
    onClick={onClick}
  >
    <span className="text-white text-2xl">&larr;</span> {/* Left arrow */}
  </div></div>
);

const CustomNextArrow = ({ onClick }:any) => (
  <div
    className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-gray-800 rounded-full p-2 cursor-pointer z-10"
    onClick={onClick}
  >
    <span className="text-white text-2xl">&rarr;</span> {/* Right arrow */}
  </div>
);
      ...
      <Slider {...settings}>
        ...
        <div className="relative flex items-center justify-center text-center">
          <div className="absolute pt-5 lg:pt-20 text-white w-full">
            ...
            <p className="mx-auto mt-2 text-sm text-primaryRegular">Get real-time alerts that keep you in the loop, so<br />you're always where the action is. Say goodbye to<br />FOMO, your next adventure is just a ping away.</p>
          </div>
        ...
        <div className="relative flex items-center justify-center text-center">
          <div className="absolute pt-5 lg:pt-20 text-white w-full">
            ...
            <p className="mx-auto mt-2 text-sm text-primaryRegular">Discover your perfect stay with our handpicked<br />selection of top-tier apartments. Each one is carefully<br />vetted for quality, comfort, and style, ensuring you<br />enjoy the best experience possible.</p>
          </div>
